  ...
  const projects = [
    {
      ...
      impact:
        "Built time-series forecasting models for gold prices and achieved 92% accuracy in adjusted closing price prediction.",
    },
    {
      name: "Qazi Dairies",
      stack: "MERN Stack, Heroku, Agile",
      impact:
        "Developed an inventory and order-tracking web app that expanded client reach by 200+ customers and reduced manual workflow errors by 30%.",
    },
    {
      name: "EDOMHI",
      stack: "Figma, UX Research, Product Design",
      impact:
        "Led research and prototype work for a 6-member team, validated with 50+ users, and improved usability scores by 40%.",
    },
    {
      name: "Credit Card Defaulters",
      stack: "Python, Pandas, Predictive Modelling",
      impact:
        "Analysed 10K+ customer records and built a model that achieved 85% accuracy in identifying high-risk defaulters.",
    },
    {
      name: "TechYard",
      stack: "Web Development, Payment Integration",
      impact:
        "Collaborated on a responsive eCommerce web app for electronic gadgets with payments and inventory modules.",
    },
    {
      name: "Salarium",
      stack: "Web App, Team Leadership",
      impact:
        "Led a 4-member team to develop a payroll tracker that streamlined salary calculations and compliance reporting for SMEs.",
    },
  ];
          ...
          <div className="grid items-center gap-12 lg:grid-cols-[1.2fr_0.8fr]">
            <div>
              ...
              <p className="mt-5 max-w-3xl text-xl leading-9 text-slate-300 md:text-2xl">
                IT Support, Systems Administration, Software Development, and
                Data Projects — presented in a polished portfolio for recruiters
                and hiring managers.
              </p>

              <p className="mt-6 max-w-2xl text-base leading-8 text-slate-400">
                UK-based Computing graduate with real business-facing technical
                experience. I solve operational problems, support critical
                systems, and build software and analytics solutions that improve
                performance.
              </p>
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                <div className="rounded-3xl border border-white/10 bg-white/5 p-5 backdrop-blur">
                  ...
                  <p className="mt-2 text-sm leading-6 text-slate-300">
                    Forecasting accuracy in gold price prediction
                  </p>
                </div>
                <div className="rounded-3xl border border-white/10 bg-white/5 p-5 backdrop-blur">
                  <p className="text-3xl font-semibold">200+</p>
                  <p className="mt-2 text-sm leading-6 text-slate-300">
                    Customers reached through a web platform project
                  </p>
                </div>
                <div className="rounded-3xl border border-white/10 bg-white/5 p-5 backdrop-blur">
                  <p className="text-3xl font-semibold">50+</p>
                  <p className="mt-2 text-sm leading-6 text-slate-300">
                    Users involved in prototype validation and UX testing
                  </p>
                </div>
              </div>
            </div>
                  ...
                  >
                    <div className="max-w-xs px-6">
                      ...
                      <p className="mt-3 text-sm leading-7 text-slate-400">
                        Save your image as
                        <span className="mx-1 rounded bg-white/10 px-2 py-1 text-slate-200">
                          saad-profile.jpg
                        </span>
        ...
        <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
          <div className="rounded-[32px] border border-white/10 bg-white/5 p-8 backdrop-blur">
            ...
            <h2 className="mt-4 text-3xl font-semibold">
              A practical technologist with business impact
            </h2>
            <p className="mt-5 text-base leading-8 text-slate-300">
              I combine academic training in computing with hands-on experience
              supporting live business operations. My work spans IT
              troubleshooting, systems administration, software development,
              analytics, and user-focused product design.
            </p>
            <p className="mt-4 text-base leading-8 text-slate-300">
              I am especially interested in roles where I can strengthen
              operations, improve internal systems, and grow across IT,
              software, and data teams while adding measurable value from day
              one.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              <h2 className="mt-2 text-3xl font-semibold">
                Why recruiters should shortlist me
              </h2>
            </div>
            <p className="max-w-2xl text-sm leading-7 text-slate-400">
              A rare combination of customer-facing technical support, business
              systems exposure, and project experience across software, UX, and
              analytics.
            </p>
          </div>
          ...
          <div className="mt-8 grid gap-5 md:grid-cols-3">
            <div className="rounded-3xl border border-white/10 bg-slate-900/70 p-6">
              ...
              <p className="mt-3 text-sm leading-7 text-slate-300">
                Comfortable supporting critical systems in fast-paced
                environments where uptime and responsiveness matter.
              </p>
            </div>
            <div className="rounded-3xl border border-white/10 bg-slate-900/70 p-6">
              <h3 className="text-lg font-semibold">Technically versatile</h3>
              <p className="mt-3 text-sm leading-7 text-slate-300">
                Brings skills across IT support, software development, machine
                learning, data analysis, and UX-focused delivery.
              </p>
            </div>
            <div className="rounded-3xl border border-white/10 bg-slate-900/70 p-6">
              <h3 className="text-lg font-semibold">Business-aware</h3>
              <p className="mt-3 text-sm leading-7 text-slate-300">
                Understands how technology supports service quality, workflow
                efficiency, customer experience, and day-to-day operations.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="projects" className="mx-auto max-w-7xl px-6 py-16 md:px-10">
        <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <h2 className="mt-2 text-3xl font-semibold">
              Proof of technical range
            </h2>
          </div>
          <p className="max-w-xl text-sm leading-7 text-slate-400">
            Projects across forecasting, eCommerce, analytics, UX validation,
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-2 xl:grid-cols-3">
          {projects.map((project) => (
            <div
              key={project.name}
              className="group rounded-[30px] border border-white/10 bg-white/5 p-6 shadow-xl shadow-black/20 backdrop-blur transition hover:-translate-y-1 hover:border-cyan-300/30 hover:bg-white/10"
            >
      ...
      <section className="mx-auto max-w-7xl px-6 pb-20 pt-16 md:px-10">
        <div className="rounded-[36px] border border-white/10 bg-gradient-to-r from-cyan-400/10 via-white/5 to-fuchsia-500/10 p-8 md:p-10 backdrop-blur-xl">
          ...
          <h2 className="mt-3 text-3xl font-semibold">
            Let’s talk about how I can add value
          </h2>
          <p className="mt-4 max-w-2xl text-base leading-8 text-slate-300">
            I am open to opportunities in IT support, systems administration,
            software development, operations technology, and data-focused roles.
            I would welcome the opportunity to speak with recruiters and hiring
            managers about where I can contribute.
          </p>
          <div className="mt-8 flex flex-wrap gap-4 text-sm">
            <a
              href="mailto:saad_qadeer@outlook.com"
              className="rounded-2xl bg-white px-6 py-3 font-semibold text-slate-950 shadow-lg shadow-white/10"
            >
              saad_qadeer@outlook.com
            </a>
            <a
              href="tel:+447774021630"
              className="rounded-2xl border border-white/15 bg-white/5 px-6 py-3 font-medium text-slate-100"
            >
              +44 7774 021630
            </a>
            <a
